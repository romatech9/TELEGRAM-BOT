import asyncio  # must be first — used in post_init before other imports settle
...
# IMPORT ALL COMMANDS FROM FILES - REMOVED VOICE STUFF
from commands.start import start
from commands.ping import ping
from commands.ai import ai, conversation_history
from commands.reset import reset
import commands.reset
# REMOVED: from commands.tts import tts
...
def main():
    ...
    # REMOVED: application.add_handler(CommandHandler("tts", tts))
   ...
   # BOT ADDED TO GROUP
    ...
    # HELP/MENU BUTTONS
    application.add_handler(
        CallbackQueryHandler(help_button_handler
    ))
    # AUTO UPDATE YT-DLP + RESTORE ZOMBIES
